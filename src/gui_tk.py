"""Legacy Tkinter control panel (fallback; the default GUI is now PySide6 in src/gui.py)

Original Tkinter control panel for the realtime voice-clone pipeline.
